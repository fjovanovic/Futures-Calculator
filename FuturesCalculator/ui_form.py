...
"border: 1px solid #000000;")
        ...
        self.pnlShortFrame.setStyleSheet(u"background-color: rgb(240, 240, 240);\n"
"border: 1px solid #000000;")
        ...
        self.pnlLeverageSlider.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.pnlCalculateBtn.setCursor(QCursor(Qt.PointingHandCursor))
...
"color: rgb(0, 0, 0);")
        ...
        self.liqLongFrame.setCursor(QCursor(Qt.PointingHandCursor))
...
"border: 1px solid #000000;")
        ...
        self.liqShortFrame.setCursor(QCursor(Qt.PointingHandCursor))
        self.liqShortFrame.setStyleSheet(u"border: 1px solid #000000;")
        ...
        self.liqLeverageSlider.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.liqCalculateBtn.setCursor(QCursor(Qt.PointingHandCursor))
...
"color: rgb(0, 0, 0);")
        ...
        self.targetLongFrame.setCursor(QCursor(Qt.PointingHandCursor))
...
"border: 1px solid #000000;")
        ...
        self.targetShortFrame.setCursor(QCursor(Qt.PointingHandCursor))
        self.targetShortFrame.setStyleSheet(u"border: 1px solid #000000;")
        ...
        self.targetLeverageSlider.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.targetCalculateBtn = QPushButton(self.tabTargetPrice)
        self.targetCalculateBtn.setObjectName(u"targetCalculateBtn")
        self.targetCalculateBtn.setCursor(QCursor(Qt.PointingHandCursor))
        self.targetCalculateBtn.setStyleSheet(u"background-color: rgb(229, 165, 10);\n"
"color: rgb(0, 0, 0);")

        self.verticalLayout_10.addWidget(self.targetCalculateBtn)
        ...
        self.tpslLongFrame.setCursor(QCursor(Qt.PointingHandCursor))
...
"border: 1px solid #000000;")
        ...
        self.tpslShortFrame.setCursor(QCursor(Qt.PointingHandCursor))
        self.tpslShortFrame.setStyleSheet(u"border: 1px solid #000000;")
        ...
        self.tpslLeverageSlider.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.tpslCalculateBtn.setCursor(QCursor(Qt.PointingHandCursor))
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.targetCalculateBtn.setText(QCoreApplication.translate("MainWindow", u"Calculate", None))
